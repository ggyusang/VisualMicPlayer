...
namespace UnityEngine.Timeline
{
	...
	public class SignalEmitter : Marker, INotification, INotificationOptionProvider
	{
		...
		NotificationFlags INotificationOptionProvider.flags
		{
			get
			{
				return (retroactive ? NotificationFlags.Retroactive : ((NotificationFlags)0)) | (emitOnce ? NotificationFlags.TriggerOnce : ((NotificationFlags)0)) | NotificationFlags.TriggerInEditMode;
			}
		}
	}
}
