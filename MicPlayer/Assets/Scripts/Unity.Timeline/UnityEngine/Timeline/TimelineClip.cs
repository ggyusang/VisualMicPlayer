...
namespace UnityEngine.Timeline
{
	...
	public class TimelineClip : ICurvesOwner, ISerializationCallbackReceiver
	{
		...
		public double clipAssetDuration
		{
			get
			{
				IPlayableAsset playableAsset = m_Asset as IPlayableAsset;
		...
		public double eastOutTime
		{
			get
			{
				return duration - easeOutDuration + m_Start;
			}
		}
		...
		public float mixInPercentage
		{
			get
			{
				return (float)(mixInDuration / duration);
			}
		}
		...
		public double mixOutTime
		{
			get
			{
				return duration - mixOutDuration + m_Start;
			}
		}
		...
		public float mixOutPercentage
		{
			get
			{
				return (float)(mixOutDuration / duration);
			}
		}
		...
		public List<string> exposedParameters
		{
			get
			{
				return m_ExposedParameterNames ?? (m_ExposedParameterNames = new List<string>());
			}
		}
		...
		public ClipCaps clipCaps
		{
			get
			{
				ITimelineClipAsset timelineClipAsset = asset as ITimelineClipAsset;
