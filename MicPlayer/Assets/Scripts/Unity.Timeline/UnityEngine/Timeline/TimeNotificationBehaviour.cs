	...
	public class TimeNotificationBehaviour : PlayableBehaviour
	{
		private struct NotificationEntry
		{
			...
			public bool triggerInEditor
			{
				get
				{
					return (flags & NotificationFlags.TriggerInEditMode) != 0;
				}
			}
			...
			public bool prewarm
			{
				get
				{
					return (flags & NotificationFlags.Retroactive) != 0;
				}
			}
			...
			public bool triggerOnce
			{
				get
				{
					return (flags & NotificationFlags.TriggerOnce) != 0;
				}
			}
		}
		...
		public override void PrepareFrame(Playable playable, FrameData info)
		{
			...
			if (info.timeLooped)
			{
				...
				{
					TriggerNotificationsInRange(0.0, duration, info, playable, false);
				}
				TriggerNotificationsInRange(0.0, time, info, playable, false);
			}
			else
			{
				double time2 = playable.GetTime();
				TriggerNotificationsInRange(m_PreviousTime, time2, info, playable, true);
			}
